...
export const getEmpleados = async (req: Request, resp: Response) => {
    ...
    try {
        ...
        const listaEmpleados = await empleados.findAll({ include: [empresas, departamentos], where: { departamentoId:departamentoId } });
    ...
    export const getEmpleado = async (req: Request, resp: Response) => {
        ...
        try {
            const empleado = await empleados.findOne({include:[empresas, departamentos], where: { id: idEmpleado } });
            if (!empleado) {
    ...
    export const busquedaEmpleadoDepartamento = async(req:Request, resp:Response)=>{
        try {         
            const {busqueda,departamentoId} = req.params;
            
            let data:any[] = []

            data = await empleados.findAll({include:[departamentos,empresas],
                where:{
